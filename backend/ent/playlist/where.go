...
// CoverTheme applies equality check predicate on the "cover_theme" field. It's identical to CoverThemeEQ.
func CoverTheme(v string) predicate.Playlist {
...
// CoverThemeEQ applies the EQ predicate on the "cover_theme" field.
func CoverThemeEQ(v string) predicate.Playlist {
	return predicate.Playlist(sql.FieldEQ(FieldCoverTheme, v))
}

// CoverThemeNEQ applies the NEQ predicate on the "cover_theme" field.
func CoverThemeNEQ(v string) predicate.Playlist {
	return predicate.Playlist(sql.FieldNEQ(FieldCoverTheme, v))
}

// CoverThemeIn applies the In predicate on the "cover_theme" field.
func CoverThemeIn(vs ...string) predicate.Playlist {
	return predicate.Playlist(sql.FieldIn(FieldCoverTheme, vs...))
}

// CoverThemeNotIn applies the NotIn predicate on the "cover_theme" field.
func CoverThemeNotIn(vs ...string) predicate.Playlist {
	return predicate.Playlist(sql.FieldNotIn(FieldCoverTheme, vs...))
}

// CoverThemeGT applies the GT predicate on the "cover_theme" field.
func CoverThemeGT(v string) predicate.Playlist {
	return predicate.Playlist(sql.FieldGT(FieldCoverTheme, v))
}

// CoverThemeGTE applies the GTE predicate on the "cover_theme" field.
func CoverThemeGTE(v string) predicate.Playlist {
	return predicate.Playlist(sql.FieldGTE(FieldCoverTheme, v))
}

// CoverThemeLT applies the LT predicate on the "cover_theme" field.
func CoverThemeLT(v string) predicate.Playlist {
	return predicate.Playlist(sql.FieldLT(FieldCoverTheme, v))
}

// CoverThemeLTE applies the LTE predicate on the "cover_theme" field.
func CoverThemeLTE(v string) predicate.Playlist {
	return predicate.Playlist(sql.FieldLTE(FieldCoverTheme, v))
}

// CoverThemeContains applies the Contains predicate on the "cover_theme" field.
func CoverThemeContains(v string) predicate.Playlist {
	return predicate.Playlist(sql.FieldContains(FieldCoverTheme, v))
}

// CoverThemeHasPrefix applies the HasPrefix predicate on the "cover_theme" field.
func CoverThemeHasPrefix(v string) predicate.Playlist {
	return predicate.Playlist(sql.FieldHasPrefix(FieldCoverTheme, v))
}

// CoverThemeHasSuffix applies the HasSuffix predicate on the "cover_theme" field.
func CoverThemeHasSuffix(v string) predicate.Playlist {
	return predicate.Playlist(sql.FieldHasSuffix(FieldCoverTheme, v))
}

// CoverThemeEqualFold applies the EqualFold predicate on the "cover_theme" field.
func CoverThemeEqualFold(v string) predicate.Playlist {
	return predicate.Playlist(sql.FieldEqualFold(FieldCoverTheme, v))
}
...
func FavoriteEQ(v bool) predicate.Playlist {
	return predicate.Playlist(sql.FieldEQ(FieldFavorite, v))
}

// FavoriteNEQ applies the NEQ predicate on the "favorite" field.
func FavoriteNEQ(v bool) predicate.Playlist {
	return predicate.Playlist(sql.FieldNEQ(FieldFavorite, v))
}
...
func HasSongsWith(preds ...predicate.Song) predicate.Playlist {
	return predicate.Playlist(func(s *sql.Selector) {
		step := newSongsStep()
