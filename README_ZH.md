...
- 主题按你提供的播放器方案实现：共 21 套——5 套原创深色（深空极夜、琥珀胶片、霓虹珊瑚、冰川极光、碳黑燃绿）、5 套原创浅色（奶白陶瓷、燕麦拿铁、薄荷苏打、樱花宣纸、黄昏琥珀）、10 套致敬（Apple Music、Spotify、网易云、Winamp、Foobar2000 各深浅一版），以及锤子音乐经典主题。
- 主题入口只放在「设置 → 站点」里的色板（带实时预览），主界面保持简洁。
