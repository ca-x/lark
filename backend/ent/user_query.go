...
type UserQuery struct {
	...
	withLibraryDirectories *LibraryDirectoryQuery
...
// QueryLibraryDirectories chains the current query on the "library_directories" edge.
func (_q *UserQuery) QueryLibraryDirectories() *LibraryDirectoryQuery {
	query := (&LibraryDirectoryClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QuerySongFavorites chains the current query on the "song_favorites" edge.
func (_q *UserQuery) QuerySongFavorites() *UserSongFavoriteQuery {
...
// QueryAlbumFavorites chains the current query on the "album_favorites" edge.
func (_q *UserQuery) QueryAlbumFavorites() *UserAlbumFavoriteQuery {
...
// QueryArtistFavorites chains the current query on the "artist_favorites" edge.
func (_q *UserQuery) QueryArtistFavorites() *UserArtistFavoriteQuery {
	query := (&UserArtistFavoriteClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *UserQuery) QueryPlayHistory() *PlayHistoryQuery {
...
func (_q *UserQuery) Clone() *UserQuery {
	...
	return &UserQuery{
		...
		withLibraryDirectories: _q.withLibraryDirectories.Clone(),
...
// WithLibraryDirectories tells the query-builder to eager-load the nodes that are connected to
// the "library_directories" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *UserQuery) WithLibraryDirectories(opts ...func(*LibraryDirectoryQuery)) *UserQuery {
	query := (&LibraryDirectoryClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withLibraryDirectories = query
	return _q
}
...
// WithSongFavorites tells the query-builder to eager-load the nodes that are connected to
// the "song_favorites" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *UserQuery) WithSongFavorites(opts ...func(*UserSongFavoriteQuery)) *UserQuery {
	query := (&UserSongFavoriteClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withSongFavorites = query
	return _q
}

// WithAlbumFavorites tells the query-builder to eager-load the nodes that are connected to
// the "album_favorites" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *UserQuery) WithAlbumFavorites(opts ...func(*UserAlbumFavoriteQuery)) *UserQuery {
	query := (&UserAlbumFavoriteClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withAlbumFavorites = query
	return _q
}

// WithArtistFavorites tells the query-builder to eager-load the nodes that are connected to
// the "artist_favorites" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *UserQuery) WithArtistFavorites(opts ...func(*UserArtistFavoriteQuery)) *UserQuery {
	query := (&UserArtistFavoriteClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UserQuery) WithPlayHistory(opts ...func(*PlayHistoryQuery)) *UserQuery {
	query := (&PlayHistoryClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := _q.withLibraryDirectories; query != nil {
		if err := _q.loadLibraryDirectories(ctx, query, nodes,
			func(n *User) { n.Edges.LibraryDirectories = []*LibraryDirectory{} },
			func(n *User, e *LibraryDirectory) { n.Edges.LibraryDirectories = append(n.Edges.LibraryDirectories, e) }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withSongFavorites; query != nil {
		if err := _q.loadSongFavorites(ctx, query, nodes,
			func(n *User) { n.Edges.SongFavorites = []*UserSongFavorite{} },
			func(n *User, e *UserSongFavorite) { n.Edges.SongFavorites = append(n.Edges.SongFavorites, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withAlbumFavorites; query != nil {
		if err := _q.loadAlbumFavorites(ctx, query, nodes,
			func(n *User) { n.Edges.AlbumFavorites = []*UserAlbumFavorite{} },
			func(n *User, e *UserAlbumFavorite) { n.Edges.AlbumFavorites = append(n.Edges.AlbumFavorites, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withArtistFavorites; query != nil {
	...
	if query := _q.withPlayHistory; query != nil {
		if err := _q.loadPlayHistory(ctx, query, nodes,
			func(n *User) { n.Edges.PlayHistory = []*PlayHistory{} },
			func(n *User, e *PlayHistory) { n.Edges.PlayHistory = append(n.Edges.PlayHistory, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *UserQuery) loadLibraryDirectories(ctx context.Context, query *LibraryDirectoryQuery, nodes []*User, init func(*User), assign func(*User, *LibraryDirectory)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.withFKs = true
	query.Where(predicate.LibraryDirectory(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.LibraryDirectoriesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.user_library_directories
		if fk == nil {
			return fmt.Errorf(`foreign-key "user_library_directories" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "user_library_directories" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (_q *UserQuery) loadSongFavorites(ctx context.Context, query *UserSongFavoriteQuery, nodes []*User, init func(*User), assign func(*User, *UserSongFavorite)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.UserSongFavorite(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.SongFavoritesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.user_song_favorites
		if fk == nil {
			return fmt.Errorf(`foreign-key "user_song_favorites" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "user_song_favorites" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *UserQuery) loadAlbumFavorites(ctx context.Context, query *UserAlbumFavoriteQuery, nodes []*User, init func(*User), assign func(*User, *UserAlbumFavorite)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.UserAlbumFavorite(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.AlbumFavoritesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.user_album_favorites
		if fk == nil {
			return fmt.Errorf(`foreign-key "user_album_favorites" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "user_album_favorites" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *UserQuery) loadArtistFavorites(ctx context.Context, query *UserArtistFavoriteQuery, nodes []*User, init func(*User), assign func(*User, *UserArtistFavorite)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.withFKs = true
	query.Where(predicate.UserArtistFavorite(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.ArtistFavoritesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.user_artist_favorites
		if fk == nil {
			return fmt.Errorf(`foreign-key "user_artist_favorites" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
...
func (_q *UserQuery) loadPlayHistory(ctx context.Context, query *PlayHistoryQuery, nodes []*User, init func(*User), assign func(*User, *PlayHistory)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.PlayHistory(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.PlayHistoryColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.user_play_history
		if fk == nil {
			return fmt.Errorf(`foreign-key "user_play_history" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "user_play_history" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
