...
func (_q *PluginQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *PluginQuery) FirstIDX(ctx context.Context) int {
...
func (_q *PluginQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *PluginQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *PluginQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *PluginQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
