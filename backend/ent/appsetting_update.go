...
func (_u *AppSettingUpdate) SetCreatedAt(v time.Time) *AppSettingUpdate {
	_u.mutation.SetCreatedAt(v)
	return _u
}

// SetNillableCreatedAt sets the "created_at" field if the given value is not nil.
func (_u *AppSettingUpdate) SetNillableCreatedAt(v *time.Time) *AppSettingUpdate {
	if v != nil {
		_u.SetCreatedAt(*v)
	}
	return _u
...
// SetCreatedAt sets the "created_at" field.
func (_u *AppSettingUpdateOne) SetCreatedAt(v time.Time) *AppSettingUpdateOne {
	_u.mutation.SetCreatedAt(v)
	return _u
}

// SetNillableCreatedAt sets the "created_at" field if the given value is not nil.
func (_u *AppSettingUpdateOne) SetNillableCreatedAt(v *time.Time) *AppSettingUpdateOne {
	if v != nil {
		_u.SetCreatedAt(*v)
	}
	return _u
