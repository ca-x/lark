...
export function LoadingStage({ t, brand = "Lark" }: { t: ReturnType<typeof createT>; brand?: string }) {
  ...
  useEffect(() => {
    const timer = window.setTimeout(() => {
      document.querySelector(".loading-enter-btn")?.classList.add("show");
    }, 1300);
