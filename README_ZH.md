...
它优先照顾本地大曲库：FLAC/WAV/Hi-Res 专辑、CUE 整轨、老格式、混乱 Tag、缺失歌词、错误封面，以及多年攒下来的目录结构。围绕听歌这件事，它也提供移动端播放、浏览器离线缓存、在线电台、Subsonic 兼容客户端、ListenBrainz/Last.fm 同步和公开分享链接。
...
- 平时用桌面和手机浏览器听歌，偶尔需要离线，也想接入 Subsonic/Navidrome 兼容客户端。
