...
func (_c *ArtistCreate) AddSongIDs(ids ...int) *ArtistCreate {
	_c.mutation.AddSongIDs(ids...)
	return _c
}

// AddSongs adds the "songs" edges to the Song entity.
func (_c *ArtistCreate) AddSongs(v ...*Song) *ArtistCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *ArtistCreate) AddUserFavoriteIDs(ids ...int) *ArtistCreate {
	_c.mutation.AddUserFavoriteIDs(ids...)
	return _c
}

// AddUserFavorites adds the "user_favorites" edges to the UserArtistFavorite entity.
func (_c *ArtistCreate) AddUserFavorites(v ...*UserArtistFavorite) *ArtistCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
